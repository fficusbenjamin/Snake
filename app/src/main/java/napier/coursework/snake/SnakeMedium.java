...
class SnakeMedium extends SurfaceView implements Runnable {
    ...
    //update the game 5 times per second (this is the medium mode)
    ...
    public SnakeMedium(Context context, Point size) {
        super(context);
